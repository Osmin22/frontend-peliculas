export function Modal({director,change,creardirector,cleardirector}){
                    ...
                    <div className="modal-body">
                        <form onSubmit={handleSave}>
                            <div className="mb-3">
                                ...
                                <input type="text" className="form-control" id="recipient-name" name='name' value={director.name} onChange={handleChange} />
                            </div>
                            <div className="modal-footer">
                                <button type="button" className="btn btn-secondary" data-bs-dismiss="modal" onClick={handleClear} >Close</button>
                                <button type="submit" className="btn btn-primary" disabled={director.name.length == 0}>Send</button>
                            </div>
                        </form>
                    </div>
                </div>
